...
- For `/codex:rescue`: never turn a failed/incomplete Codex run into a Claude-side implementation attempt — report the failure and stop. If Codex was never successfully invoked, do not generate a substitute answer at all.
